namespace EnergyTrading.Mdm.Client.Services
{
    ...
    public interface IMdmService
    {
        ...
        /// <returns></returns>
        WebResponse<MdmId> CreateMapping<TContract>(int id, MdmId identifier)
            where TContract : IMdmEntity;
        ...
        /// <param name="identifier"></param>
        /// <returns></returns>
        WebResponse<TContract> Get<TContract>(MdmId identifier)
            where TContract : IMdmEntity;
        ...
        /// <param name="asof"></param>
        /// <returns></returns>
        WebResponse<TContract> Get<TContract>(MdmId identifier, DateTime? asof)
            where TContract : IMdmEntity;
        ...
        /// <returns></returns>
        WebResponse<MdmId> GetMapping<TContract>(int id, Predicate<MdmId> query)
            where TContract : IMdmEntity;
        ...
        /// <returns></returns>
        WebResponse<MdmId> Map<TContract>(int id, string targetSystem)
            where TContract : IMdmEntity;
        ...
        /// <param name="targetSystem"></param>
        /// <returns></returns>
        WebResponse<MappingResponse> CrossMap<TContract>(MdmId identifier, string targetSystem)
            where TContract : IMdmEntity;
