...
namespace MDM.Client.IntegrationTests.BrokerCommodity.MdmEntityLocatorFactory
{
    ...
    {
        private BrokerCommodity expected;
        ...
        protected override void OnSetup()
        {
            ...
            expected = BrokerCommodityData.PostBasicEntity();
        }
        ...
        public void ShouldSuccessfullyLocateEntity()
        {
            ...
            // when
            var candidate = this.MdmEntityLocatorService.Get<BrokerCommodity>(nexusId);
        ...
        public void ShouldReturnDefaultWhenUnableToLocateEntity()
        {
            ...
            // then
            Assert.AreEqual(default(BrokerCommodity), candidate);
        }
    }
}
