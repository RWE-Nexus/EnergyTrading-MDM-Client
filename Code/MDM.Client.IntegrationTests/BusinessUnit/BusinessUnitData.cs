...
namespace MDM.Client.IntegrationTests.BusinessUnit
{
    ...
    {
        public static BusinessUnit PostBasicEntity()
        {
            var mdmService = ServiceLocator.Current.GetInstance<IMdmEntityService<BusinessUnit>>();
        ...
        protected static void SetAdditionalData(BusinessUnit entity)
        {
