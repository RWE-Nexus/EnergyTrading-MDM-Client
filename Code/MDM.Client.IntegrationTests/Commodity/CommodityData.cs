...
namespace MDM.Client.IntegrationTests.Commodity
{
    ...
    {
        public static Commodity PostBasicEntity()
        {
            var mdmService = ServiceLocator.Current.GetInstance<IMdmEntityService<Commodity>>();
        ...
        protected static void SetAdditionalData(Commodity entity)
        {
