...
namespace MDM.Client.IntegrationTests.CommodityFeeType.MdmEntityLocatorFactory
{
    ...
    {
        private CommodityFeeType expected;
        ...
        protected override void OnSetup()
        {
            ...
            expected = CommodityFeeTypeData.PostBasicEntity();
        }
        ...
        public void ShouldSuccessfullyLocateEntity()
        {
            ...
            // when
            var candidate = this.MdmEntityLocatorService.Get<CommodityFeeType>(nexusId);
        ...
        public void ShouldReturnDefaultWhenUnableToLocateEntity()
        {
            ...
            // then
            Assert.AreEqual(default(CommodityFeeType), candidate);
        }
    }
}
