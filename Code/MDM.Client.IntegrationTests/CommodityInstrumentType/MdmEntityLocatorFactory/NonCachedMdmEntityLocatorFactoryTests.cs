...
namespace MDM.Client.IntegrationTests.CommodityInstrumentType.MdmEntityLocatorFactory
{
    ...
    {
        private CommodityInstrumentType expected;
        ...
        protected override void OnSetup()
        {
            ...
            expected = CommodityInstrumentTypeData.PostBasicEntity();
        }
        ...
        public void ShouldSuccessfullyLocateEntity()
        {
            ...
            // when
            var candidate = this.MdmEntityLocatorService.Get<CommodityInstrumentType>(nexusId);
        ...
        public void ShouldReturnDefaultWhenUnableToLocateEntity()
        {
            ...
            // then
            Assert.AreEqual(default(CommodityInstrumentType), candidate);
        }
    }
}
