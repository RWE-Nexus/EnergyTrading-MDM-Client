...
namespace MDM.Client.IntegrationTests.Counterparty.MdmEntityLocatorFactory
{
    ...
    public class NonCachedMdmEntityLocatorFactoryTests : MdmEntityLocatorFactoryIntegrationTestBase
    {
        ...
        protected override void OnSetup()
        {
            ...
            expected = CounterpartyData.PostBasicEntity();
        }
        ...
        public void ShouldSuccessfullyLocateEntity()
        {
            ...
            // when
            var candidate = this.MdmEntityLocatorService.Get<Counterparty>(nexusId);
        ...
        public void ShouldReturnDefaultWhenUnableToLocateEntity()
        {
            ...
            // then
            Assert.AreEqual(default(Counterparty), candidate);
        }
    }
}
