...
namespace MDM.Client.IntegrationTests.Dimension
{
    ...
    {
        public static Dimension PostBasicEntity()
        {
            var mdmService = ServiceLocator.Current.GetInstance<IMdmEntityService<Dimension>>();
        ...
        protected static void SetAdditionalData(Dimension entity)
        {
