...
namespace MDM.Client.IntegrationTests.FeeType
{
    ...
    {
        public static FeeType PostBasicEntity()
        {
            var mdmService = ServiceLocator.Current.GetInstance<IMdmEntityService<FeeType>>();
        ...
        protected static void SetAdditionalData(FeeType entity)
        {
