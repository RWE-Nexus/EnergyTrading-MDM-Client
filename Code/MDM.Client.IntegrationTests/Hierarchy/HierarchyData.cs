...
namespace MDM.Client.IntegrationTests.Hierarchy
{
    ...
    {
        public static Hierarchy PostBasicEntity()
        {
            var mdmService = ServiceLocator.Current.GetInstance<IMdmEntityService<Hierarchy>>();
        ...
        protected static void SetAdditionalData(Hierarchy entity)
        {
