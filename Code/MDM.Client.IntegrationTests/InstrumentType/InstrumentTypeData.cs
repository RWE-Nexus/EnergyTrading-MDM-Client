...
namespace MDM.Client.IntegrationTests.InstrumentType
{
    ...
    {
        public static InstrumentType PostBasicEntity()
        {
            var mdmService = ServiceLocator.Current.GetInstance<IMdmEntityService<InstrumentType>>();
        ...
        protected static void SetAdditionalData(InstrumentType entity)
        {
