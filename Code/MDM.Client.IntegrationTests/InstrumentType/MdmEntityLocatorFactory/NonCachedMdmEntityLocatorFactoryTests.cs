...
namespace MDM.Client.IntegrationTests.InstrumentType.MdmEntityLocatorFactory
{
    ...
    {
        private InstrumentType expected;
        ...
        protected override void OnSetup()
        {
            ...
            expected = InstrumentTypeData.PostBasicEntity();
        }
        ...
        public void ShouldSuccessfullyLocateEntity()
        {
            ...
            // when
            var candidate = this.MdmEntityLocatorService.Get<InstrumentType>(nexusId);
        ...
        public void ShouldReturnDefaultWhenUnableToLocateEntity()
        {
            ...
            // then
            Assert.AreEqual(default(InstrumentType), candidate);
        }
    }
}
