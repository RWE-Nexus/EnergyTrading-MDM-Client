...
namespace MDM.Client.IntegrationTests.InstrumentTypeOverride
{
    ...
    public class InstrumentTypeOverrideData
    {
        public static InstrumentTypeOverride PostBasicEntity()
        {
            var mdmService = ServiceLocator.Current.GetInstance<IMdmEntityService<InstrumentTypeOverride>>();
        ...
        protected static void SetAdditionalData(InstrumentTypeOverride entity)
        {
