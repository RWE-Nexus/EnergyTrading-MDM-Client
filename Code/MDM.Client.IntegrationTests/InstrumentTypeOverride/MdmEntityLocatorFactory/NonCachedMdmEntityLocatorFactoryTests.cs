...
namespace MDM.Client.IntegrationTests.InstrumentTypeOverride.MdmEntityLocatorFactory
{
    ...
    {
        private InstrumentTypeOverride expected;
        ...
        protected override void OnSetup()
        {
            ...
            expected = InstrumentTypeOverrideData.PostBasicEntity();
        }
        ...
        public void ShouldSuccessfullyLocateEntity()
        {
            ...
            // when
            var candidate = this.MdmEntityLocatorService.Get<InstrumentTypeOverride>(nexusId);
        ...
        public void ShouldReturnDefaultWhenUnableToLocateEntity()
        {
            ...
            // then
            Assert.AreEqual(default(InstrumentTypeOverride), candidate);
        }
    }
}
