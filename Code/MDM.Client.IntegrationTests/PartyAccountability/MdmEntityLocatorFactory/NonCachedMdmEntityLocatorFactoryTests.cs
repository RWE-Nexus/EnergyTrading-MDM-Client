...
namespace MDM.Client.IntegrationTests.PartyAccountability.MdmEntityLocatorFactory
{
    ...
    {
        private PartyAccountability expected;
        ...
        protected override void OnSetup()
        {
            ...
            expected = PartyAccountabilityData.PostBasicEntity();
        }
        ...
        public void ShouldSuccessfullyLocateEntity()
        {
            ...
            // when
            var candidate = this.MdmEntityLocatorService.Get<PartyAccountability>(nexusId);
        ...
        public void ShouldReturnDefaultWhenUnableToLocateEntity()
        {
            ...
            // then
            Assert.AreEqual(default(PartyAccountability), candidate);
        }
    }
}
