...
namespace MDM.Client.IntegrationTests.PartyAccountability
{
    ...
    public class PartyAccountabilityData
    {
        public static PartyAccountability PostBasicEntity()
        {
            var mdmService = ServiceLocator.Current.GetInstance<IMdmEntityService<PartyAccountability>>();
        ...
        protected static void SetAdditionalData(PartyAccountability entity)
        {
