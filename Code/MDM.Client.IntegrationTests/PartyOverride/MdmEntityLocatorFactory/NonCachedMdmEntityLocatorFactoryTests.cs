...
namespace MDM.Client.IntegrationTests.PartyOverride.MdmEntityLocatorFactory
{
    ...
    {
        private PartyOverride expected;
        ...
        protected override void OnSetup()
        {
            ...
            expected = PartyOverrideData.PostBasicEntity();
        }
        ...
        public void ShouldSuccessfullyLocateEntity()
        {
            ...
            // when
            var candidate = this.MdmEntityLocatorService.Get<PartyOverride>(nexusId);
        ...
        public void ShouldReturnDefaultWhenUnableToLocateEntity()
        {
            ...
            // then
            Assert.AreEqual(default(PartyOverride), candidate);
        }
    }
}
