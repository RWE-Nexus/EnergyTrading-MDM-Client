...
namespace MDM.Client.IntegrationTests.Person
{
    ...
    {
        public static Person PostBasicEntity()
        {
            var mdmService = ServiceLocator.Current.GetInstance<IMdmEntityService<Person>>();
