...
namespace MDM.Client.IntegrationTests.Portfolio
{
    ...
    {
        public static Portfolio PostBasicEntity()
        {
            var mdmService = ServiceLocator.Current.GetInstance<IMdmEntityService<Portfolio>>();
        ...
        protected static void SetAdditionalData(Portfolio entity)
        {
			
            entity.Details.PortfolioType = "Global";
