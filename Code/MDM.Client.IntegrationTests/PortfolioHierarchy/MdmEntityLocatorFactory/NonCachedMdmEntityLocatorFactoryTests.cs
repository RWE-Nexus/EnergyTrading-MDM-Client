...
namespace MDM.Client.IntegrationTests.PortfolioHierarchy.MdmEntityLocatorFactory
{
    ...
    {
        private PortfolioHierarchy expected;
        ...
        protected override void OnSetup()
        {
            ...
            expected = PortfolioHierarchyData.PostBasicEntity();
        }
        ...
        public void ShouldSuccessfullyLocateEntity()
        {
            ...
            // when
            var candidate = this.MdmEntityLocatorService.Get<PortfolioHierarchy>(nexusId);
        ...
        public void ShouldReturnDefaultWhenUnableToLocateEntity()
        {
            ...
            // then
            Assert.AreEqual(default(PortfolioHierarchy), candidate);
        }
    }
}
