...
namespace MDM.Client.IntegrationTests.PortfolioHierarchy
{
    ...
    public class PortfolioHierarchyData
    {
        public static PortfolioHierarchy PostBasicEntity()
        {
            var mdmService = ServiceLocator.Current.GetInstance<IMdmEntityService<PortfolioHierarchy>>();
        ...
        protected static void SetAdditionalData(PortfolioHierarchy entity)
        {
			
            entity.Details.ChildPortfolio = IntegrationTests.Portfolio.PortfolioData.PostBasicEntity().ToNexusId().ToEntityId();
            entity.Details.ParentPortfolio = IntegrationTests.Portfolio.PortfolioData.PostBasicEntity().ToNexusId().ToEntityId();
