...
namespace MDM.Client.IntegrationTests.ProductDelivery.MdmEntityLocatorFactory
{
    ...
    {
        private ProductDelivery expected;
        ...
        protected override void OnSetup()
        {
            ...
            expected = ProductDeliveryData.PostBasicEntity();
        }
        ...
        public void ShouldSuccessfullyLocateEntity()
        {
            ...
            // when
            var candidate = this.MdmEntityLocatorService.Get<ProductDelivery>(nexusId);
        ...
        public void ShouldReturnDefaultWhenUnableToLocateEntity()
        {
            ...
            // then
            Assert.AreEqual(default(ProductDelivery), candidate);
        }
    }
}
