...
namespace MDM.Client.IntegrationTests.ProductSettlementCurve
{
    ...
    public class ProductSettlementCurveData
    {
        public static ProductSettlementCurve PostBasicEntity()
        {
            var mdmService = ServiceLocator.Current.GetInstance<IMdmEntityService<ProductSettlementCurve>>();

            var entity = ObjectMother.Create<ProductSettlementCurve>();
        ...
        protected static void SetAdditionalData(ProductSettlementCurve entity)
        {
