...
namespace MDM.Client.IntegrationTests.ProductTenorType.MdmEntityLocatorFactory
{
    ...
    {
        private ProductTenorType expected;
        ...
        protected override void OnSetup()
        {
            ...
            expected = ProductTenorTypeData.PostBasicEntity();
        }
        ...
        public void ShouldSuccessfullyLocateEntity()
        {
            ...
            // when
            var candidate = this.MdmEntityLocatorService.Get<ProductTenorType>(nexusId);
        ...
        public void ShouldReturnDefaultWhenUnableToLocateEntity()
        {
            ...
            // then
            Assert.AreEqual(default(ProductTenorType), candidate);
        }
    }
}
