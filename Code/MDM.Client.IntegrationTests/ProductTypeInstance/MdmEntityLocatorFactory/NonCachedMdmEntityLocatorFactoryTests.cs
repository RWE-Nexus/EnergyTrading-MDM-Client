...
namespace MDM.Client.IntegrationTests.ProductTypeInstance.MdmEntityLocatorFactory
{
    ...
    {
        private ProductTypeInstance expected;
        ...
        protected override void OnSetup()
        {
            ...
            expected = ProductTypeInstanceData.PostBasicEntity();
        }
        ...
        public void ShouldSuccessfullyLocateEntity()
        {
            ...
            // when
            var candidate = this.MdmEntityLocatorService.Get<ProductTypeInstance>(nexusId);
        ...
        public void ShouldReturnDefaultWhenUnableToLocateEntity()
        {
            ...
            // then
            Assert.AreEqual(default(ProductTypeInstance), candidate);
        }
    }
}
