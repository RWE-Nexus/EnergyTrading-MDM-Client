...
namespace MDM.Client.IntegrationTests.SettlementContact.MdmEntityLocatorFactory
{
    ...
    {
        private SettlementContact expected;
        ...
        protected override void OnSetup()
        {
            ...
            expected = SettlementContactData.PostBasicEntity();
        }
        ...
        public void ShouldSuccessfullyLocateEntity()
        {
            ...
            // when
            var candidate = this.MdmEntityLocatorService.Get<SettlementContact>(nexusId);
        ...
        public void ShouldReturnDefaultWhenUnableToLocateEntity()
        {
            ...
            // then
            Assert.AreEqual(default(SettlementContact), candidate);
        }
    }
}
