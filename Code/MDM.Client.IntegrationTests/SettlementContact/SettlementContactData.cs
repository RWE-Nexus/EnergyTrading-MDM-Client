...
namespace MDM.Client.IntegrationTests.SettlementContact
{
    ...
    public class SettlementContactData
    {
        public static SettlementContact PostBasicEntity()
        {
            var mdmService = ServiceLocator.Current.GetInstance<IMdmEntityService<SettlementContact>>();
        ...
        protected static void SetAdditionalData(SettlementContact entity)
        {
