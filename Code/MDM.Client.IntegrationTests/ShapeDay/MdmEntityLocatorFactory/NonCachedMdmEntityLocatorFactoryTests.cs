...
namespace MDM.Client.IntegrationTests.ShapeDay.MdmEntityLocatorFactory
{
    ...
    public class NonCachedMdmEntityLocatorFactoryTests : MdmEntityLocatorFactoryIntegrationTestBase
    {
        ...
        protected override void OnSetup()
        {
            ...
            expected = ShapeDayData.PostBasicEntity();
        }
        ...
        public void ShouldSuccessfullyLocateEntity()
        {
            ...
            // when
            var candidate = this.MdmEntityLocatorService.Get<ShapeDay>(nexusId);
        ...
        public void ShouldReturnDefaultWhenUnableToLocateEntity()
        {
            ...
            // then
            Assert.AreEqual(default(ShapeDay), candidate);
        }
    }
}
