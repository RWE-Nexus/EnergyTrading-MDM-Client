...
namespace MDM.Client.IntegrationTests.ShapeElement
{
    ...
    {
        public static ShapeElement PostBasicEntity()
        {
            var mdmService = ServiceLocator.Current.GetInstance<IMdmEntityService<ShapeElement>>();
        ...
        protected static void SetAdditionalData(ShapeElement entity)
        {
			
            entity.Details.Period = new DateRange { StartDate = new System.DateTime(2010, 01, 01), EndDate = new System.DateTime(2020, 01, 01) };
