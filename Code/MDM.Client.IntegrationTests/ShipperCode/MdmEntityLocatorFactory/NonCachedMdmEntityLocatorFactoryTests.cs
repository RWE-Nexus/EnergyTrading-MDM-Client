...
namespace MDM.Client.IntegrationTests.ShipperCode.MdmEntityLocatorFactory
{
    ...
    public class NonCachedMdmEntityLocatorFactoryTests : MdmEntityLocatorFactoryIntegrationTestBase
    {
        ...
        protected override void OnSetup()
        {
            ...
            expected = ShipperCodeData.PostBasicEntity();
        }
        ...
        public void ShouldSuccessfullyLocateEntity()
        {
            ...
            // when
            var candidate = this.MdmEntityLocatorService.Get<ShipperCode>(nexusId);
        ...
        public void ShouldReturnDefaultWhenUnableToLocateEntity()
        {
            ...
            // then
            Assert.AreEqual(default(ShipperCode), candidate);
        }
    }
}
