...
namespace MDM.Client.IntegrationTests.Unit
{
    ...
    {
        public static Unit PostBasicEntity()
        {
            var mdmService = ServiceLocator.Current.GetInstance<IMdmEntityService<Unit>>();
        ...
        protected static void SetAdditionalData(Unit entity)
        {
