...
namespace MDM.Client.IntegrationTests.Vessel
{
    ...
    {
        public static Vessel PostBasicEntity()
        {
            var mdmService = ServiceLocator.Current.GetInstance<IMdmEntityService<Vessel>>();
        ...
        protected static void SetAdditionalData(Vessel entity)
        {
