namespace EnergyTrading.MDM.Client.Registrars
{
    ...
    using EnergyTrading.MDM.Client.WcfRestClient;
    ...
    /// <summary>
    /// Initializes the services required to use the MDM client
    /// </summary>
    public class MdmClientRegistrarWcf : IContainerRegistrar
    {
