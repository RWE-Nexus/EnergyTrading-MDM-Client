namespace EnergyTrading.MDM.Client.Services
{
         ...
         where TContract : IMdmEntity
    {
        ...
        /// <returns></returns>
        WebResponse<NexusId> CreateMapping(int id, NexusId identifier);
        ...
        /// <returns></returns>
        WebResponse<MappingResponse> CrossMap(NexusId identifier, string targetSystem);
        ...
        /// <param name="identifier"></param>
        /// <returns></returns>
        WebResponse<TContract> Get(NexusId identifier);
        ...
        /// <param name="validAt"></param>
        /// <returns></returns>
        WebResponse<TContract> Get(NexusId identifier, DateTime? validAt);
        ...
        /// <returns></returns>
        WebResponse<NexusId> GetMapping(int id, Predicate<NexusId> query);
        ...
        /// <param name="targetSystem"></param>
        /// <returns></returns>
        WebResponse<NexusId> Map(int id, string targetSystem);
